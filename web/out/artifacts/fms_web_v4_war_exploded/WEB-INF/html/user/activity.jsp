        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="activity.action" method="get" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                    ...
                    <table id="tblSystem" class="table table-striped table-bordered m-b-none text-sm table-hover">
                        ...
                        <s:iterator var="item" value="activitys" status="stat">
                            <tr>
                                ...
                                <td class="text-center"><a href="<s:property  value="#item.indirectObjectName"/>"><s:property  value="#item.objectName"/></a></td>
                        ...
                        <div class="col-sm-12 text-right text-center-xs">
                            <ul class="pagination pagination-sm m-t-none m-b-none">
                                <s:if test="%{page.pageNumber > 1}">
                                    <li><a href="/utility/user/activity.action?page.pageNumber=<s:property value="%{page.pageNumber}" />">«</a></li>
                                </s:if>
                                <s:iterator var="item" value="page.pageList" status="stat">
                                    <li><a href="/utility/user/activity.action?page.pageNumber=<s:property value="#item" />"><s:property value="#item"/></a></li>
                                </s:iterator>
                                <s:if test="%{page.pageNumber < page.getPageCount()}">
                                    <li><a href="/utility/user/activity.action?page.pageNumber=<s:property value="%{page.pageNumber + 2}" />">»</a></li>
                                </s:if>
                            </ul>
                        </div>
                    </div>
