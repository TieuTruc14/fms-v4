...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md"> <h3 class="m-b-none"><s:property value="getTitleText('fms.feedback.info')"/></h3> </div>

            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.feedback.info')"/></header>
                <div class="panel-body">
                <s:form role="form" theme="simple">
                        <div class="col-sm-12">
                            <div class="btn-toolbar m-b-sm btn-editor" data-role="editor-toolbar"
                                 data-target="#editor">
                                <div class="btn-group"><a class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" title="Font">
                                ...
                                <input type="text" class="form-control-trans pull-left"
                                       data-edit="inserttext" id="voiceBtn" x-webkit-speech=""
                                       style="width:25px;height:28px;"></div>
                            <div id="editor" class="form-control"
                                 style="overflow:scroll;height:200px;max-height:250px"> </div>
                            <textarea hidden="true" name="contentText" id="contentText"></textarea>

                            <div class="line line-dashed line-lg pull-in"></div>
                            <div >
                                    <a class="btn  btn-default " href="/index.action"><i class="fa fa-reply"></i><s:property value="getTitleText('fms.button.cancel')"/> </a>
                                    <button id="btnSubmit" type="submit" formaction="form.success.action" class="btn btn-primary "><s:property value="getTitleText('fms.feedback.send')"/> </button>
                            </div>
                        </div>
...
<!-- wysiwyg -->
<script src="/assets/note/js/wysiwyg/jquery.hotkeys.js"></script>
<script src="/assets/note/js/wysiwyg/bootstrap-wysiwyg.js"></script>
<%--<script src="/assets/note/js/wysiwyg/demo.js"></script>--%>
    ...
    $(document).ready(function() {
       /* $("#btnSubmit").on("click", function() {
        ...
        $('#btnSubmit').bind('click', function () {
            $("#contentText").val($("#editor").html()/*.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')*/);
        });
