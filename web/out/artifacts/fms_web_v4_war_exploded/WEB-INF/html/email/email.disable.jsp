  ...
  <div id="wrap">
    ...
    <div class="container">
      <div class="page-header">
        <h1>Hủy nhận email thành công!</h1>
      </div>
      <p class="lead">Hủy nhận email thành công! Hệ thống giám sát hành trình EPOSI sẽ ngừng các thông tin hoạt động thiết bị tới quý khách.</p>
    </div>
  </div>
