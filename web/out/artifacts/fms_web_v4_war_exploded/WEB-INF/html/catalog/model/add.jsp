    ...
    <section class="scrollable padder">
      ...
      <div class="m-b-md">
        ...
        <s:if test="actionErrors.contains('action.error.permissionGSHT')">
            <div class="alert"> <i class="fa fa-info-sign"></i>
                <code>Bạn không thể thêm model của loại hàng hóa TB giám sát hành trình!</code>
            </div>
        </s:if>
      <section class="panel panel-default">
        ...
        <div class="panel-body">
          <s:form method="post" action="model.addnew.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
            <s:hidden name="goodsId" />
            <div class="form-group">
              <label class="col-sm-2 control-label">Mã model</label>
              <div class="col-sm-10">
                <div class="input-group m-b">
                                      <span class="input-group-addon">
                                          <i class="fa fa-fw fa-pencil"></i>
                                      </span>
                  <s:textfield name="item.id" cssStyle="width:100%;max-width:250px;" cssClass="form-control" maxlength="16" placeholder="Model" />
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-crop"></i></span>
                  <s:textfield name="item.name" cssStyle="width:100%;max-width:250px;"  placeholder="Tên model" cssClass="form-control" />
                </div>
              </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
...
<script>
  $(document).ready(function() {
    $("#model_addnew_save_item_productType_id").select2();
  });
