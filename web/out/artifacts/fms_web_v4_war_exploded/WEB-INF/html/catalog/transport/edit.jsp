...
<s:set var="formAction" value="%{'transport.edit.save'}" />
<s:if test="(item == null) || (item.id == null) || (item.id == '')">
    <s:set var="update" value="%{'addnew'}" />
    <s:set var="formAction" value="%{'transport.addnew.save'}" />
</s:if>
...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                    <h3 class="m-b-none"><s:property value="getTitleText('fms.menu.transport.type')" /></h3>
            </div>
                        ...
                        <s:form method="post" action="%{#formAction}" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b">
                                        ...
                                        <s:textfield name="item.name" cssStyle="width:100%;max-width:250px;" maxlength="100" placeholder="%{getTitltText('fms.report.title.name')}" cssClass="form-control" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a href="/catalog/transport.list.action" class="btn btn-default"><s:property value="getTitleText('fms.button.cancel')" /></a>
