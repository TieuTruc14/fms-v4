    ...
    <section class="scrollable padder">
      ...
      <section class="panel panel-default">
        ...
        <div class="panel-body">
          <s:form method="post" action="customer.type.addnew.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group m-b">
                  ...
                  <s:textfield name="item.id" cssClass="form-control" cssStyle="width:100%;max-width:250px;" maxlength="16" placeholder="Mã loại khách hàng" />
                </div>
