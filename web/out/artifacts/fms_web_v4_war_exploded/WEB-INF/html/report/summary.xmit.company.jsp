...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in"> <li><a href="/index.action"><i class="fa fa-home"></i>&nbsp;<s:property value="getTitleText('fms.header.home')" /></a></li> <li><a href="/report.bgt/index.action"><s:property value="getTitleText('fms.menu.report')" /></a></li> <li><a href="#"><s:property value="getTitleText('fms.menu.report.summary')" /></a></li> <li class="active"><s:property value="getTitleText('fms.menu.report.send.data')" /></li> </ul>
            <div class="m-b-md"> <h3 class="m-b-none"><s:property value="getTitleText('fms.menu.report.summary.data')"/></h3> </div>
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="summary.xmit.company.action" method="get" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><s:property value="getTitleText('fms.menu.company')"/></label>
                            <div class="col-sm-10">
                ...
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.header.data')" />
                    <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="summary.xmit.company.action?start=<s:property value="start" />&end=<s:property value="end" />&format=xlsx">Excel XLSX</a></li>
                            <li class="divider"></li>
                    ...
                    <table id="tblReportData" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <s:iterator var="item" value="items" status="stat">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" href="#"><s:property value="#item.vehicleId" /> <b class="caret"></b></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="#">Thông tin</a></li>
                                            <li><a href="xmit.vehicle.action?vehicleId=<s:property value="vehicleId" />&start=<s:property value="start" />&end=<s:property value="end" />"><s:property value="getTitleText('fms.menu.report.detail')" /></a></li>
                                        </ul>
                                    </div>
                                </td>
                                <td class="text-center"><s:property value="#item.msgCount"/></td>

                                <td class="text-center"><a href="xmit.vehicle.action?vehicleId=<s:property value="vehicleId" />&start=<s:property value="start" />&end=<s:property value="end" />"><s:property value="#item.countGPSNoSignal" /></a></td>
                                <td class="text-center"><a href="xmit.vehicle.action?vehicleId=<s:property value="vehicleId" />&start=<s:property value="start" />&end=<s:property value="end" />"><s:property value="@org.apache.commons.lang3.time.DurationFormatUtils@formatDuration(#item.gpsNoSignalDuration* 1000, 'HH:mm:ss')" /></a></td>

                                <td class="text-center"><a href="xmit.vehicle.action?vehicleId=<s:property value="vehicleId" />&start=<s:property value="start" />&end=<s:property value="end" />"><s:property value="#item.countDataNoSignal" /></a></td>
                                <td class="text-center"><a href="xmit.vehicle.action?vehicleId=<s:property value="vehicleId" />&start=<s:property value="start" />&end=<s:property value="end" />"><s:property value="@org.apache.commons.lang3.time.DurationFormatUtils@formatDuration(#item.dataNoSignalDuration* 1000, 'HH:mm:ss')" /></a></td>
                            </tr>
                        </s:iterator>
                        </tbody>
                        <tfoot>
