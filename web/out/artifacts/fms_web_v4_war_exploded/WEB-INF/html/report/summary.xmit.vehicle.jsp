        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="summary.xmit.vehicle.action" method="get" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                ...
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.header.data')" />
                    <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="xmit.vehicle.action?vehicleId=<s:property value="vehicleId" />&start=<s:property value="start" />&end=<s:property value="end" />&format=xlsx">Excel XLSX</a></li>
                            <li class="divider"></li>
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tblReportData" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center" rowspan="2"><s:property value="getTitleText('fms.utility.date')"/></th>
                        ...
                        <s:iterator var="item" value="items" status="stat">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><s:property value="#item.date"/></td>
                        ...
                        <tr>
                            ...
                            <th class="text-center"><s:property value="#totalGPSDuration" /></th>
                            <th class="text-center"><s:property value="#totalDataCount" /></th>
                            <th class="text-center"><s:property value="#totalDataDuration" /></th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
