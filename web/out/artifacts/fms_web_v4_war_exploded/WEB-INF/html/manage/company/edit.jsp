        ...
        <section class="scrollable padder">
            ...
            <s:else>
                ...
                <section class="panel panel-default">
                    <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.menu.company.edit')" /></header>
                    <div class="panel-body">
                        <s:form id="company" method="post" action="edit.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-tag"></i></span> <s:textfield name="item.code" cssClass="form-control" cssStyle="width:100%;max-width:250px;" maxlength="128" placeholder="MST/CMT"/></div>
                                    <s:fielderror cssStyle="color: red" fieldName="item.code"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-phone"></i></span>
                                        <s:textfield name="item.phone" cssClass="form-control" cssStyle="width:100%;max-width:250px;" placeholder="Phone" />
                                    </div>
                            ...
                            <div class="line line-dashed line-lg pull-in"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><s:property value="getTitleText('fms.report.title.status')"/> <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-cog"></i></span>
                                        <s:select key="item.status" label="Trạng thái" inputPrepend="" cssStyle="width:100%;max-width:250px;" cssClass="form-control"
                                                  required="true" placeholder="Trạng thái"
                                                  list="#{'0':'Hoạt động','1':'Khóa','2':'Hủy'}"
                                                  value="item.status">
                                        </s:select>
