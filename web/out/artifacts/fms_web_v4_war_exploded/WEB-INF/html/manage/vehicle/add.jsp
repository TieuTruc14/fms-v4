...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md"><h3 class="m-b-none"><s:property value="getTitleText('fms.menu.vehicle.addnew')"/></h3>
            </div>
            ...
            <s:else>
                <s:if test="actionErrors.contains('action.error.dupplicate')">
                    <div class="alert"> <i class="fa fa-info-sign"></i>
                        <h4><code><s:property value="getTitleText('fms.vehicle.was.exists')"/>!</code></h4>
                    </div>
                </s:if>
            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i><s:property value="getTitleText('fms.menu.vehicle.update')"/> </header>
                <div class="panel-body">
                    <s:form method="post" action="vehicle.addnew.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><s:property value="getTitleText('fms.menu.vehicle')"/> (*)</label>
                            <div class="col-sm-10">
                                <s:hidden name="item.company.id" value="%{company.id}"/>

                                <s:hidden name="companyId" value="%{company.id}"/>
                                <div class="input-group m-b">
                                    <span class="input-group-addon"><i class="fa fa-fw fa-truck"></i></span>
                                    <s:textfield name="item.id" maxlength="13" placeholder="Biển số" cssStyle="width:100%;max-width:250px;" cssClass="form-control" />
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><s:property value="getTitleText('fms.menu.fuel.type')"/> (*)</label>
                            <div class="col-sm-10">
                                <div class="input-group m-b">
                                    <s:select theme="simple"
                                              cssClass=" selectpicker span2"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div>
                                    <label class="checkbox-inline">
                                        <s:checkbox name="item.bgt" fieldValue="true" label="bộ giao thông"/>QC31
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div >
                                    <label class="checkbox-inline">
                                        <s:checkbox name="item.onFilter" fieldValue="true" value="true" label="onFilter"/>onFilter
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div >
                                    <label class="checkbox-inline">
                                        <s:checkbox name="item.disable" fieldValue="true" value="false" label="Khóa"/><s:property value="getTitleText('fms.vehicle.lock')"/>
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group m-b">
                                    <span class="input-group-addon"><i class="fa fa-fw fa-truck"></i></span>
                                    <s:textfield name="item.note"  placeholder="%{getTitleText('fms.report.title.note')}" cssClass="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="line line-dashed line-lg pull-in"></div>
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a href="vehicle.list.action" class="btn btn-default"><s:property value="getTitleText('fms.button.cancel')" /></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#vehicle_addnew_save_item_type_id").select2();
        $("#vehicle_addnew_save_item_fuelType_id").select2();
        $("#vehicle_addnew_save_item_driver_id").select2();
        $("#vehicle_addnew_save_item_workVehicleMapping").select2();
    });
</script>
