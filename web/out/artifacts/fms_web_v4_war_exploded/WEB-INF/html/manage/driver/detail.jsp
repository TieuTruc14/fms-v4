        ...
        <section class="scrollable">
            ...
            <section class="hbox stretch">
                <aside class="aside-lg b-r">
                    ...
                    <div class="wrapper">
                        <div>
                            <small class="text-uc text-xs text-muted"><s:property value="getTitleText('fms.driver.code')"/></small><p><code><s:property value="item.id" /></code></p>
                            <small class="text-uc text-xs text-muted"><s:property value="getTitleText('fms.driver.name')"/></small><p><s:property value="item.name" /></p>
                            ...
                            <small class="text-uc text-xs text-muted"><s:property value="getTitleText('fms.driver.licensekey')"/></small><p><code><s:property value="item.licenceKey" /></code></p>
                            <small class="text-uc text-xs text-muted"><s:property value="getTitleText('fms.report.title.date.effect')"/></small><p><code><s:property value="strlicenseDay" /></code></p>
                            <small class="text-uc text-xs text-muted"><s:property value="getTitleText('fms.report.title.date.expire')"/></small><p><code><s:property value="strlicenseExp" /></code></p>
                        ...
                        <div class="line"></div>
                        <p><a href="/manage/driver/driver.edit.action?driverId=<s:property value="item.id" />&companyId=<s:property value="item.company.id"/>" class="btn btn-default btn-block"><i class="fa fa-pencil pull-left"></i><s:property value="getTitleText('fms.button.edit')"/></a></p>
                        </sec:authorize>
                    </div>
                </aside>
