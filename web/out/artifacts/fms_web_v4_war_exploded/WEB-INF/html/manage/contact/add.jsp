            ...
            <div class="panel-body">
              <s:form method="post" action="addnew.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-crop"></i></span>
                      <s:textfield name="item.phone"  cssStyle="width:100%;max-width: 250px;" placeholder="Số Điện thoại" cssClass="form-control" />
                    </div>
                  </div>
                </div>
                <div class="line line-dashed line-lg pull-in"></div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-crop"></i></span>
                      <s:textfield name="item.position"  cssStyle="width:100%;max-width: 250px;" placeholder="chức vụ" cssClass="form-control" />
                    </div>
                  </div>
                </div>
                <div class="line line-dashed line-lg pull-in"></div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-crop"></i></span>
                      <s:textarea name="item.note"  cssStyle="width:100%;max-width: 250px;" placeholder="Ghi chú" cssClass="form-control" />
                    </div>
                  </div>
                </div>
