...
<sec:authorize access="hasAnyRole('ROLE_CUSTOMER_TYPE_VIEW')">
    <section class="scrollable padder">
      <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
        ...
        <li><a href="/catalog/customer.type.list.action"><s:property value="getTitleText('fms.menu.catalog.model')" /></a></li>
      </ul>
      ...
      <section class="panel panel-default">
        <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.header.data')" />
          <div class="btn-group pull-right">
            <sec:authorize access="hasAnyRole('ROLE_CUSTOMER_TYPE_ADD')">
              <a class=" btn-sm btn-primary pull-right" href="/catalog/customer.type.addnew.action"><i class="fa fa-plus"></i> <s:property value="getTitleText('fms.button.addnew')" /></a>
            </sec:authorize>
          </div>
        </header>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <sec:authorize access="hasAnyRole('ROLE_CUSTOMER_TYPE_EDIT')">
                    <ul class="dropdown-menu pull-right">
                      <li><a href="/catalog/customer.type.edit.action?id=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i> <s:property value="getTitleText('fms.button.edit')" /></a></li>
                    </ul>
                    </sec:authorize>
                  </div>
                </td>
