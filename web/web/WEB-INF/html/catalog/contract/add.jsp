  ...
  <section class="vbox">
    <section class="scrollable padder">
      <ul class="breadcrumb no-border no-radius b-b b-light pull-in"> <li><a href="/index.action"><i class="fa fa-home"></i>&nbsp;<s:property value="getTitleText('fms.header.home')" /></a></li> <li><a href="javascript:void(0)"><s:property value="getTitleText('fms.menu.catalog')" /></a></li>
        <li><a href="/catalog/contract.list.action"><s:property value="getTitleText('fms.menu.catalog.model')"/></a></li></ul>
      <div class="m-b-md">
      ...
      <section class="panel panel-default">
        ...
        <div class="panel-body">
          <s:form method="post" action="contract.addnew.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group m-b">
                  ...
                  <s:textfield name="item.id" cssClass="form-control" maxlength="16" cssStyle="width:100%;max-width:250px;" placeholder="Mã loại hợp đồng" />
                </div>
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-offset-2">
                <a href="/catalog/contract.list.action" class="btn btn-default"><s:property value="getTitleText('fms.button.cancel')" /></a>
