    ...
    <sec:authorize access="hasAnyRole('ROLE_TRANSPORT_VIEW')">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/catalog/transport.list.action"><s:property value="getTitleText('fms.menu.transport.type')" /></a></li>
            </ul>
            <div class="m-b-md"> <h3 class="m-b-none"><s:property value="getTitleText('fms.menu.transport.type')" /></h3> </div>
            ...
            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i>&nbsp;<s:property value="getTitleText('fms.header.data')" />
                    <div class="btn-group pull-right">
                        <sec:authorize access="hasAnyRole('ROLE_TRANSPORT_ADD')">
                            <a class="btn-sm btn-primary pull-right" href="/catalog/transport.addnew.action"><i class="fa fa-plus"></i> <s:property value="getTitleText('fms.button.addnew')" /></a>
                        </sec:authorize>
                    </div>
                </header>
                <div class="table-responsive">
                    <table id="tblTransport" class="table table-striped table-bordered m-b-none text-sm">
                        <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <sec:authorize access="hasAnyRole('ROLE_TRANSPORT_EDIT')">
                                        <ul class="dropdown-menu pull-right">
                                          <li><a href="/catalog/transport.edit.action?id=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i> <s:property value="getTitleText('fms.button.edit')" /></a></li>
                                        </ul>
                                        </sec:authorize>
                                    </div>
                                </td>
                        ...
                        <div class="col-sm-12 text-right text-center-xs">
                            <ul class="pagination pagination-sm m-t-none m-b-none">
                                <s:if test="%{page.pageNumber > 1}">
                                    <li><a href="/catalog/transport.list.action?page.pageNumber=<s:property value="%{page.pageNumber}" />">«</a></li>
                                </s:if>
                                <s:iterator var="item" value="page.pageList" status="stat">
                                    <li><a href="/catalog/transport.list.action?page.pageNumber=<s:property value="#item" />">
                                        <s:property value="#item" /></a></li>
                                </s:iterator>
                                <s:if test="%{page.pageNumber < page.getPageCount()}">
                                    <li><a href="/catalog/transport.list.action?page.pageNumber=<s:property value="%{page.pageNumber + 2 }" />">»</a></li>
                                </s:if>
                            </ul>
                        </div>
                    </div>
