    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <div class="m-b-md"> <h3 class="m-b-none"><s:property value="getTitleText('fms.menu.company.addnew')" /> <s:if test="companyLeader!=null">trực thuộc "<s:property value="companyLeader.name"/>"</s:if></h3> </div>
            ...
            <s:else>
                <s:if test="actionErrors.contains('action.error.space')">
                    <div class="alert alert-info"> <i class="fa fa-info-sign"></i><code><s:property value="getTitleText('fms.please.complete.infor')"/> </code>
                    </div>
                </s:if>
                <s:if test="actionErrors.contains('action.error.exits')">
                    <div class="alert alert-info"> <i class="fa fa-info-sign"></i><code><h5><s:property value="getTitleText('fms.owner.not.exsits')"/></h5></code> </div>
                </s:if>
                <s:elseif test="actionErrors.contains('action.error.duplicate')">
                    <div class="alert alert-info"> <i class="fa fa-info-sign"></i><code><h5><s:property value="getTitleText('fms.owner.was.exists')"/> <s:property value="item.owner"/>!</h5></code> </div>
                </s:elseif>
                ...
                <section class="panel panel-default">
                    <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.menu.company.addnew')" /></header>
                    <div class="panel-body">
                        <s:form id="company" method="post" action="addnew.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                            <s:hidden  name="companyLead"/>
                            <s:hidden  name="companyLeader.name"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-tag"></i></span> <s:textfield name="item.owner" cssClass="form-control"  cssStyle="width:100%;max-width:250px;" type="number" placeholder="Owner"/></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-tag"></i></span> <s:textfield name="item.name" cssClass="form-control" cssStyle="width:100%;max-width:250px;" maxlength="128" placeholder="%{getTitleText('fms.menu.company.name')}"/></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-tag"></i></span> <s:textfield name="item.code" cssClass="form-control" cssStyle="width:100%;max-width:250px;"  placeholder="MST/CMT"  /></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-phone"></i></span>
                                        <s:textfield name="item.phone" id="phoneId" cssClass="form-control"  cssStyle="width:100%;max-width:250px;" placeholder="Phone" />
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-envelope-o"></i></span> <s:textfield name="item.email" cssClass="form-control" cssStyle="width:100%;max-width:250px;" placeholder="Email" /></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"> <span class="input-group-addon"><i class="fa fa-fw fa-globe"></i></span> <s:textfield name="item.url" cssClass="form-control" cssStyle="width:100%;max-width:250px;" placeholder="http://eposi.vn" /></div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-3">
                                            <s:select theme="simple"
                                                      ...
                                                      id="communeId"
                                                      headerKey=""
                                                      headerValue="Chọn phường/xã"
                                                      data-width="auto"
                                                      cssStyle="width:100%;height: 30px"
                                                    />
                                        </div>
                                        <div class="col-sm-3">
                                            <s:textfield name="item.address.no"  cssStyle="width:100%;height:27px;" placeholder="%{getTitleText('fms.company.address.house')}"  />
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="line line-dashed line-lg pull-in"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><s:property value="getTitleText('fms.report.department')"/><code>(*)</code></label>
                                <div class="col-sm-10">
                                    <s:select theme="simple"
                                              cssClass="selectpicker span2"
                                              label="%{getTitleText('fms.report.choice.department')}"
                                              ...
                                              listKey="id"
                                              listValue="fullName"
                                              name="item.province.id"
                                              headerKey=""
                                              headerValue="%{getTitleText('fms.report.choice.department')}"
                                              data-width="auto"
                                              cssStyle="width:293px;height: 30px"
                                            />
                                    <s:fielderror cssStyle="color: red" fieldName="item.province.id"/>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a href="/manage/company/list.action" class="btn btn-default"><s:property value="getTitleText('fms.button.cancel')" /></a>
