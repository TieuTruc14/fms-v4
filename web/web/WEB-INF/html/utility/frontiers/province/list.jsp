    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active"><a href="/utility/province/list.action"><s:property value="getTitleText('fms.menu.provinces')" /></a></li>
            </ul>
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tblProvince" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center"><s:property value="getTitleText('fms.menu.province.name')"/></th>
                            <th class="box-shadow-inner small_col text-center"><s:property value="getTitleText('fms.menu.vehicle.license')"/></th>
                        ...
                        <s:iterator var="item" value="items" status="stat">
                            <tr>
                                ...
                                <td><a href="/utility/province/detail.action?id=<s:property value="#item.id"/>"><s:property value="#item.name"/></a></td>
                                <td><s:property value="#item.maBienSo"/></td>
