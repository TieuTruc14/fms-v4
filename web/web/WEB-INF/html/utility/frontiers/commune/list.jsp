    ...
    <section class="scrollable padder">
      ...
      <section class="panel panel-default">
        ...
        <div class="table-responsive table-overflow-x-fix">
          <table id="tblCommune" class="table table-striped table-bordered m-b-none text-sm">
            <thead>
            <tr>
            ...
            <s:iterator var="item" value="items" status="stat">
              <tr>
                ...
                <td><a href="/utility/commune/detail.action?id=<s:property value="#item.id"/>"><s:property value="#item.fullName"/></a></td>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                      <li><a href="/utility/commune/detail.action?id=<s:property value="#item.id"/>"><s:property value="getTitleText('fms.menu.report.detail')" /></a></li>
                    </ul>
                  </div>
                </td>
              </tr>
