    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                ...
                <s:else>
                    <h3 class="m-b-none"><s:property value="getTitleText('fms.menu.device.update')" /></h3>
                </s:else>
            </div>
                    ...
                    <div class="panel-body">
                        <s:form method="post" action="edit.save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-daterange">
                                        <s:textfield id="strDateEnd" name="strDateEnd" placeholder="%{getTitleText('fms.report.title.date.expire')}" theme="simple" cssClass="input-small input-sm input-s-sm form-control inline"/>
                                    </div>
