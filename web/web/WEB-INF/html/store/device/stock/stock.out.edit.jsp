    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active"><a href="javascript:void(0)"><s:property value="getTitleText('fms.admin.management.stock.update')" /></a></li>
            </ul>
            <div class="m-b-md"> <h3 class="m-b-none"><s:property value="getTitleText('fms.admin.management.stock.update')" /></h3> </div>
            ...
            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> <s:property value="getTitleText('fms.admin.management.stock.edit')" /></header>
                <div class="panel-body">
                    <s:form method="post" action="stock.out.edit.save.action" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
...
<script>
    $(document).ready(function() {
        $("#stock_out_edit_save_action_item_companyDes_id").select2();
    });
