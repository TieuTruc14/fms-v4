        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="batch.xmit.action" method="get" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Lô</label>
                            <div class="col-sm-10">
                                <s:select theme="simple"
                                          cssClass="selectpicker span2"
                                          label="Chọn lô"
                                          list="ListBatchInterceptor_batches"
                                          listKey="id"
                                          listValue="id"
                                          name="batchId"
                                          headerKey=""
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tblReportData" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center" rowspan="2">Tên lô</th>
                            <th class="box-shadow-inner small_col text-center" rowspan="2">Số thiết bị</th>
                        ...
                        <s:iterator var="item" value="items" status="stat">
                            <s:set var="totalGPSCount"     value="%{#item.gpsCount + #attr.totalGPSCount}" />
                            <s:set var="totalGPSDuration"  value="%{#item.gpsDuration + #attr.totalGPSDuration}" />
                            <s:set var="totalDataCount"    value="%{#item.dataCount + #attr.totalDataCount}" />
                            <s:set var="totalDataDuration" value="%{#item.dataDuration + #attr.totalDataDuration}" />

                            <tr>
                                <td><s:property value="#stat.count" /></td>
                                <td>
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" href="#"><s:property value="#item.name" /> <b class="caret"></b></a>
                                ...
                                <td class="text-center"><s:property value="#item.deviceCount"/></td>
                                <td class="text-center"><s:property value="#item.date"/></td>
                                <td class="text-center"><s:property value="#item.gpsCount" /></td>
                                <td class="text-center"><s:property value="@org.apache.commons.lang3.time.DurationFormatUtils@formatDuration(#item.gpsDuration* 1000, 'HH:mm:ss')" /></td>

                                <td class="text-center"><s:property value="#item.dataCount" /></td>
                                <td class="text-center"><s:property value="@org.apache.commons.lang3.time.DurationFormatUtils@formatDuration(#item.dataDuration* 1000, 'HH:mm:ss')" /></td>
                            </tr>
                        </s:iterator>
                        </tbody>
                        <tfoot>
