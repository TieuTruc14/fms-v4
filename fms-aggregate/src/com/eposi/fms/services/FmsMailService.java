...
public class FmsMailService extends AbstractBean {
    ...
    private static final String KONEXY_MAIL_HOST = "mail.konexy.com";           // Assuming you are sending email from localhost
    private static final String KONEXY_MAIL_FROM_ADDRESS = "admin@konexy.com";  // Sender's email ID needs to be mentioned
    private static final String KONEXY_MAIL_USERNAME = "admin";  // Sender's email ID needs to be mentioned
    private static final String KONEXY_MAIL_PASSWORD = "konexy@2015";           // password of admin@konexy.com
